    ...
    <div className={styles.evidenceColumns}>
      ...
      <div><h3>Injuries & teammates</h3>
        ...
        {availability?.status==='observed' && <>
          <p><a href={availability.source_url} target="_blank" rel="noreferrer">ESPN injury report</a> · <a href={availability.roster_source_url} target="_blank" rel="noreferrer">Current roster</a><br />Captured {time(availability.captured_at)}</p>
