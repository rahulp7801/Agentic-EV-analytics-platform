...
export const REASONS:Record<string,string>={
  ...
  teammate_availability_unmodeled:'A confirmed acute teammate absence is not covered by a validated probability adjustment.',
  ...
  edge_review_limit:'This legacy record was blocked by a retired point-edge ceiling and needs a fresh scan.',
