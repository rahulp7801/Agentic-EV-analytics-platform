...
const signal={player:'Player',sport:'nfl',forecast_cutoff:'2026-09-17',snapped_at:'2026-09-16T20:00:00Z',prop_type:'receptions',line:4,direction:'under'};
...
test('history cutoff uses the earlier target or UTC price-capture day and rejects unknown timing',()=>{
  assert.equal(historyCutoff(signal),'2026-09-16');
  assert.equal(historyCutoff({...signal,forecast_cutoff:'2026-09-14'}),'2026-09-14');
  assert.equal(historyCutoff({...signal,snapped_at:'2026-09-15T23:30:00-02:00'}),'2026-09-16');
