...
test('API boundary rejects mutation, ambiguous query values, excess input and cross-site browser reads',()=>{
  ...
  assert.equal(publicRequest(request('/api/signals','GET',{'sec-fetch-site':'cross-site'})),403);
