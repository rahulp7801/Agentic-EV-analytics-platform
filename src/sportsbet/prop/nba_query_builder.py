...
SELECT
    COUNT(*) AS total,
    SUM(CASE WHEN (points + rebounds + assists) > CAST($3 AS double precision) THEN 1 ELSE 0 END) AS successes,
    SUM(CASE WHEN (points + rebounds + assists) = CAST($3 AS double precision) THEN 1 ELSE 0 END) AS pushes,
