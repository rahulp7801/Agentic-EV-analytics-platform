"""Public DraftKings/ESPN readers. Access and schema availability are not guaranteed.

PrizePicks projections are collected separately because entry payouts are not
sportsbook odds. Missing prices, timestamps, or identities must remain missing.
"""
