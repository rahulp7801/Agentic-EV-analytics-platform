...
- Hit rate and each populated calibration bin include a nominal 95% Wilson interval, and reports include fixed 10-bin calibration error. These binomial intervals treat selections as independent and do not adjust for players sharing games. ROI, Brier, log loss and CLV remain point estimates until a justified clustered evaluation design is implemented.
